# Demandas Consolidadas — PKG-01 A PKG-100

Arquivo histórico criado em 2026-07-26 para retirar do backlog ativo os pacotes
consolidados sem apagar, resumir ou reinterpretar suas evidências. O conteúdo
abaixo é a cópia integral do antigo `DEMANDAS.md` e permanece como fonte de
consulta para decisões, critérios, estados, riscos e rollback dos pacotes
`PKG-01` a `PKG-100`.

Não usar este arquivo para registrar novos lotes. Novas demandas executáveis
ficam em `DEMANDAS.md`.
