...
- Na aba Operacao do detalhe da impressora, o card `Impressão` fica em faixa propria e inclui os limites de `Machine`; `Temperaturas` fica abaixo em largura cheia. Nenhum card deve ser esticado para acompanhar a altura de outro card ou criar area vazia interna.
