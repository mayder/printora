...
- Checklist manual do PKG-30 na tela Firmware: abrir com impressora offline e confirmar erro de Moonraker sem esconder o resumo local do catalogo; abrir com impressora online e confirmar MCUs/placas detectadas e cadastradas primeiro; associar modelo fisico sugerido quando existir; confirmar badges de preset local ou preset ausente; abrir link do guia Esoterical CANBus como referencia; confirmar que nenhuma acao de build, flash, update, SSH ou alteracao local nasce do catalogo.
