...
- A página `/c/{slug}` possui abas: `Feed`, `Arquivos`, `Mods`, `Perfis`, `Membros` e `Impressoras públicas`. Feed e arquivos começam como placeholders operacionais documentados; mods usam os mods públicos declarados nas impressoras até existir biblioteca dedicada.
