...
- A primeira tela de Social usa abas: `Comunidades`, `Impressoras`, `Makers` e `Relações`, com filtros, cards/listas e estados vazios úteis. Cards de makers mostram avatar/monograma, nome, slug, bio, impressoras públicas, localização e ação principal para abrir o perfil.
