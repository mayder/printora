...
- Na tela Agentes, a lista global deve mostrar versão instalada e versão esperada, com ação contextual para criar job remoto de atualização do agente selecionado.
