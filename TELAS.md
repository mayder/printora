...
- A Central de alertas aberta pela topbar e da frota. Ela deve permitir abrir a impressora afetada quando o alerta pertencer a um registro especifico.
...
- Na tela Agentes, a lista global deve mostrar versão instalada e versão esperada, com ação contextual para atualizar o agente selecionado. Agente atual usa job remoto; agente legado usa SSH configurado pela impressora; comando manual aparece apenas quando não há caminho automático.
