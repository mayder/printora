...
- Na tela Agentes, o pareamento permite gerar token curto para a impressora selecionada, copiar o token uma única vez, listar tokens por prefixo/status, revogar tokens ativos, remover tokens inativos da gestão visual, listar agentes ativos, revogar agente, rotacionar credencial e remover agentes revogados da gestão visual sem apagar auditoria.
