import{S as e}from"./sindarius-gcodeviewer.es-DDimEmKV.js";import"./mainUVVaryingDeclaration-BLmFIH15.js";import"./helperFunctions-CzwHTACi.js";import"./index-B5yfkrT0.js";import"./react-vendor-9t-2b6dQ.js";import"./icons-CNFEcl-l.js";import"./meshUboDeclaration-QQNqJuNn.js";const o="decalFragmentDeclaration",I=`#ifdef DECAL
...
`;e.IncludesShadersStore[t]||(e.IncludesShadersStore[t]=A);const r="prePassDeclaration",T=`#ifdef PREPASS
...
#endif
#endif
`;e.IncludesShadersStore[r]||(e.IncludesShadersStore[r]=T);const a="oitDeclaration",P=`#ifdef ORDER_INDEPENDENT_TRANSPARENCY
#extension GL_EXT_draw_buffers : require
...
#endif
`;e.IncludesShadersStore[a]||(e.IncludesShadersStore[a]=P);const n="lightFragmentDeclaration",x=`#ifdef LIGHT{X}
...
#endif
#endif
`;e.IncludesShadersStore[n]||(e.IncludesShadersStore[n]=x);const l="lightUboDeclaration",X=`#ifdef LIGHT{X}
uniform Light{X}
...
#endif
result.Diffuse=LTCEvaluate( normal,viewDir,position,mat3( 1.0 ),rectCoords );return result;}`;e.IncludesShadersStore[f]||(e.IncludesShadersStore[f]=F);const s="lightsFragmentFunctions",R=`struct lightingInfo
{vec3 diffuse;
#ifdef SPECULARTERM
vec3 specular;
#endif
...
#endif
`;e.IncludesShadersStore[s]||(e.IncludesShadersStore[s]=R);const d="shadowsFragmentFunctions",N=`#ifdef SHADOWS
...
#endif
#endif
`;e.IncludesShadersStore[d]||(e.IncludesShadersStore[d]=N);const c="samplerFragmentDeclaration",M=`#ifdef _DEFINENAME_
...
#endif
`;e.IncludesShadersStore[c]||(e.IncludesShadersStore[c]=M);const h="fresnelFunction",O=`#ifdef FRESNEL
float computeFresnelTerm(vec3 viewDirection,vec3 worldNormal,float bias,float power)
{float fresnelTerm=pow(bias+abs(dot(viewDirection,worldNormal)),power);return clamp(fresnelTerm,0.,1.);}
#endif
`;e.IncludesShadersStore[h]||(e.IncludesShadersStore[h]=O);const v="reflectionFunction",y=`vec3 computeFixedEquirectangularCoords(vec4 worldPos,vec3 worldNormal,vec3 direction)
...
#endif
`;e.IncludesShadersStore[v]||(e.IncludesShadersStore[v]=y);const u="imageProcessingDeclaration",b=`#ifdef EXPOSURE
...
#endif
`;e.IncludesShadersStore[u]||(e.IncludesShadersStore[u]=b);const p="imageProcessingFunctions",_=`#if defined(COLORGRADING) && !defined(COLORGRADING3D)
/** 
...
return result;}`;e.IncludesShadersStore[p]||(e.IncludesShadersStore[p]=_);const m="bumpFragmentMainFunctions",U=`#if defined(BUMP) || defined(CLEARCOAT_BUMP) || defined(ANISOTROPIC) || defined(DETAIL)
...
#endif
`;e.IncludesShadersStore[m]||(e.IncludesShadersStore[m]=U);const S="bumpFragmentFunctions",W=`#if defined(BUMP)
...
#endif
`;e.IncludesShadersStore[S]||(e.IncludesShadersStore[S]=W);const g="bumpFragment",z=`vec2 uvOffset=vec2(0.0,0.0);
...
#endif
`;e.IncludesShadersStore[g]||(e.IncludesShadersStore[g]=z);const E="decalFragment",H=`#ifdef DECAL
#ifdef GAMMADECAL
...
#endif
`;e.IncludesShadersStore[E]||(e.IncludesShadersStore[E]=H);const C="depthPrePass",V=`#ifdef DEPTHPREPASS
gl_FragColor=vec4(0.,0.,0.,1.0);return;
#endif
`;e.IncludesShadersStore[C]||(e.IncludesShadersStore[C]=V);const D="lightFragment",G=`#ifdef LIGHT{X}
...
#endif
#endif
`;e.IncludesShadersStore[D]||(e.IncludesShadersStore[D]=G);const w="oitFragment",B=`#ifdef ORDER_INDEPENDENT_TRANSPARENCY
...
#endif
`;e.IncludesShadersStore[w]||(e.IncludesShadersStore[w]=B);const i="defaultPixelShader",L=`#define CUSTOM_FRAGMENT_EXTENSION
...
`;e.ShadersStore[i]||(e.ShadersStore[i]=L);const J={name:i,shader:L};export{J as defaultPixelShader};
