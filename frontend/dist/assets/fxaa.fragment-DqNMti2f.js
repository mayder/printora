...
fragmentOutputs.color=textureSampleLevel(textureSampler,textureSamplerSampler,posM,0.0);
#endif
}`;e.ShadersStoreWGSL[a]||(e.ShadersStoreWGSL[a]=r);const p={name:a,shader:r};export{p as fxaaPixelShaderWGSL};
