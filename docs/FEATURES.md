# Recursos E Endpoints Do Printora

Este arquivo concentra os detalhes longos de módulos e endpoints. O guia rápido para abrir a aplicação fica no `README.md`.
