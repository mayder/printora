...
- módulos Python: 155;
- endpoints HTTP/WebSocket: 331;
- contratos tipados: 344;
- tabelas declaradas em SQL: 118;
...
| `finance` | Finanças e pedidos | Ledger, pedidos, pagamentos, reconciliação, risco e repasses. | 7 | 5 |
