...
- módulos Python: 157;
- endpoints HTTP/WebSocket: 335;
- contratos tipados: 351;
- tabelas declaradas em SQL: 124;
...
| `finance` | Finanças e pedidos | Ledger, pedidos, pagamentos, reconciliação, risco e repasses. | 9 | 11 |
