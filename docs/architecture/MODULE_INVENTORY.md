...
- módulos Python: 156;
- endpoints HTTP/WebSocket: 334;
- contratos tipados: 349;
- tabelas declaradas em SQL: 120;
...
| `finance` | Finanças e pedidos | Ledger, pedidos, pagamentos, reconciliação, risco e repasses. | 8 | 7 |
